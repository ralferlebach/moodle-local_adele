...
<template>
  <div>
    <button
      ...
      @click="goBack"
    >
      <i class="fas fa-arrow-left" /> {{ store.state.strings.completion_go_back_learningpath }}
    </button>
    <div
    ...
    <div class="card">
      <div class="card-body">
        ...
        <ul class="list-group list-group-flush">
          ...
          <li class="list-group-item">
            <i class="fas fa-tag" /> {{ store.state.strings.completion_course_tags }} {{ store.state.node.tags }}
          </li>
        </ul>
